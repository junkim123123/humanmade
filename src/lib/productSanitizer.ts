...
const IP_PATTERNS = [
  ...
  { pattern: /chiikawa|먼작귀/gi, replacement: "Licensed Character Toy (Auth Required)", category: "character" as const },
  { pattern: /shin-chan|crayon shin-chan|짱구/gi, replacement: "Licensed Character Toy (Auth Required)", category: "character" as const },
  { pattern: /doraemon|도라에몽/gi, replacement: "Licensed Character Toy (Auth Required)", category: "character" as const },
  ...
  { pattern: /pororo|뽀로로/gi, replacement: "K-Character Toy", category: "character" as const },
  { pattern: /secret jouju|시크릿 쥬쥬/gi, replacement: "K-Character Toy", category: "character" as const },
  ...
  { pattern: /keroro|개구리 중사 케로로/gi, replacement: "Anime Collection Figure", category: "character" as const },
  // Brands
