...
export const sampleReport: Report = {
  ...
  // Extras: UI-only and sample-only fields
  extras: {
    // Enhanced proof data with inputStatus
    proof: {
      hsCode: "1704.90",
      hsConfidence: 92,
      labelTerms: ["Gelatin", "Sugar", "Natural flavors", "Citric acid", "Natural colors"],
    ...
    // Enhanced inputStatus with additional fields
    inputStatus: {
      productPhotoUploaded: true,
      barcodePhotoUploaded: true,
      labelPhotoUploaded: true,
    ...
    // Enhanced inferredInputs with originCountry and hsCode
    inferredInputs: {
      shippingMode: {
        value: "air",
        source: "from_customs",
